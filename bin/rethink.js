...
function create(iframe) {
    ...
    window._registry = new _SandboxRegistry2.default(window._miniBus);
...
},{"runtime-core/src/bus/MiniBus":2,"runtime-core/src/sandbox/Sandbox":3,"runtime-core/src/sandbox/SandboxRegistry":4}],6:[function(require,module,exports){
'use strict';
...
},{"./RuntimeUAStub":7}],7:[function(require,module,exports){
'use strict';
...
var RethinkBrowser = {
    install: function install(domain) {
        var iframe = (0, _iframe.create)('https://' + domain + '/.well-known/runtime/index.html');
                ...
                return new Promise(function (resolve, reject) {
                    var loaded = function loaded(e) {
                        if (e.data.to === 'runtime:loadedHyperty') {
                            ...
                            resolve(_ContextApp2.default.getHyperty(e.data.body.runtimeHypertyURL));
                        }
                    };
...
},{"./ContextApp":5,"./iframe":8}],8:[function(require,module,exports){
'use strict';
