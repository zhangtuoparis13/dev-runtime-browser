...
$__System.register('22', ['4', '5', '6', '7', '8'], function (_export) {
    var _get, _inherits, _createClass, _classCallCheck, Sandbox, SandboxRegistry, SandboxWorker;
...
!function(e) {
  if ("object" == typeof exports && "undefined" != typeof module)
    ...
    var t;
    t = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof self ? self : this, t.runtimeUA = e();
  }
}(function() {
  var define,
      module,
              ...
              value: function(e, t) {
                var n,
                    ...
                    r = new Promise(function(r, i) {
                      void 0 === o._messageBus && i("MessageBus not found on registerStub"), t.indexOf("msg-node.") || (t = t.substring(t.indexOf(".") + 1)), n = "msg-node." + t + "/protostub/" + Math.floor(1e4 * Math.random() + 1), o.protostubsList[t] = n, o.sandboxesList[t] = e, r(n), o._messageBus.addListener(n + "/status", function(e) {
        ...
        return function(t, n, o) {
          ...
          i = function() {
            function e() {
              o(this, e);
              var t = this;
              t.mockupHypertyDescriptor(), t.mockupStubDescriptor();
            }
            return r(e, [{
              key: "mockupHypertyDescriptor",
              value: function() {
                var e = this;
                e._makeExternalRequest("../resources/descriptors/Hyperties.json").then(function(t) {
                  e.Hyperties = JSON.parse(t);
                });
              }
            }, {
              ...
              value: function() {
                var e = this;
                e._makeExternalRequest("../resources/descriptors/ProtoStubs.json").then(function(t) {
                  e.ProtoStubs = JSON.parse(t);
                });
              }
            }, {
        ...
        return function(t, n, o) {
          ...
          v = function() {
            function e(t) {
              ...
              n.runtimeURL = o, n.runtimeCatalogue.runtimeURL = o, n.identityModule = new c["default"];
              var i = t.createAppSandbox();
              n.registry = new a["default"](o, i, n.identityModule), n.policyEngine = new f["default"](n.identityModule, n.registry), n.messageBus = new p["default"](n.registry), n.messageBus.pipeline.handlers = [function(e) {
              ...
              value: function(e) {
                ...
                return new Promise(function(n, o) {
                  ...
                  console.info("------------------ Hyperty ------------------------"), console.info("Get hyperty descriptor for :", e), t.runtimeCatalogue.getHypertyDescriptor(e).then(function(e) {
                    ...
                    console.error("4.1: try to register a new sandbox", e);
                    var n = t.sandboxFactory.createSandbox();
